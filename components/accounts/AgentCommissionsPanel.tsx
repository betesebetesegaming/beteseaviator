  ...
  return (
    <div className="space-y-4">
      <p className="text-sm text-slate-400">
        {adminView
          ? "5% of each period’s GGR profit from that agent’s customers. Today, week, and month are different totals — a new month starts at zero."
          : "Your 5% of GGR profit from customers on your link. Today, week, and month each have their own figure. Next month starts at zero."}
      </p>
